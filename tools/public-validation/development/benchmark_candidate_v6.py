#!/usr/bin/env python3
"""Run candidate policies on the inspected v6 development evidence."""
...
BENCHMARK_PATH = VALIDATION_ROOT / "benchmark_v6.py"


def load_benchmark():
    specification = importlib.util.spec_from_file_location(
        "ingot_public_validation_v6_development", BENCHMARK_PATH
    )
    if specification is None or specification.loader is None:
        raise RuntimeError("unable to load the v6 public-validation evaluator")
...
def main() -> None:
    ...
    payload = {
        "schema": "ingot-public-validation-candidate-development-v6",
        "evidence_status": "development-regression-only",
        "source_protocol": "v6-inspected-not-external",
        "records": records,
        "summary": summary,
    }
