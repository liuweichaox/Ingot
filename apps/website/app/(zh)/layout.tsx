...
export const metadata: Metadata = {
  ...
  description: "把真实周期、过程轨迹和检验结果连成可追溯证据：解释这一炉的偏差来自哪个变量、哪段轨迹，再用物理先验与贝叶斯优化推荐下一炉参数。",
  ...
  openGraph: {
    title: "Ingot — 看清这一炉，算准下一炉",
    description: "面向高成本、小样本制造实验的开源工艺追因与优化系统。",
    url: origin,
    type: "website",
    locale: "zh_CN",
    siteName: "Ingot",
    images: [{ url: "/og.png", width: 1734, height: 909, alt: "Ingot — 看清这一炉，算准下一炉。" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Ingot — 开源工艺追因与优化系统",
    description: "从真实过程证据，到偏差的解释和下一炉可验证的工艺参数。",
    images: ["/og.png"],
  },
};
