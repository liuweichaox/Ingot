...
const copy = {
  zh: {
    ...
    github: "查看 GitHub",
    eyebrow: "AI PROCESS R&D · CLOSED-LOOP OPTIMIZATION",
    titleA: "让每一次试验，",
    titleB: "都逼近最优工艺。",
    lead: "Ingot 把设备轨迹、实际配方和质量结果变成可学习的实验，让物理先验与贝叶斯优化共同决定下一炉——更少试验，更快收敛，并始终尊重工艺安全边界。",
    primary: "探索产品能力",
    secondary: "查看源代码",
    truth: ["多目标优化", "小样本学习", "安全约束", "跨产品迁移"],
    ...
    productText: "不是在采集系统上附加一个算法页面，而是围绕“下一次该做什么实验”重新组织数据、模型、决策和知识。",
    productCards: [
      ["01", "研发 Campaign", "定义控制变量、目标、硬边界、质量约束、试验成本和停止条件。"],
      ["02", "实验自动成组", "用 RunKey 自动关联设定值、实际轨迹、过程特征、检验结果和有效性。"],
      ["03", "下一炉推荐", "给出单点或批量候选、预测区间、安全概率、信息增益和推荐理由。"],
    ...
    visionTitle: "换场景，不换优化系统。",
    visionText: "Ingot 的可复用资产不是任何设备地址表，而是完整的序贯实验优化能力。",
    reusable: [
    ...
    ctaText: "先回放历史，再辅助下一炉，最终让每一种新工艺都从上一种工艺的知识出发。",
    ctaPrimary: "启动第一个 Campaign",
    ctaSecondary: "打开 GitHub",
    footer: "Ingot · Open-source process optimization for real manufacturing experiments.",
  },
  en: {
    switchLabel: "中文",
    switchHref: "/",
    ...
    eyebrow: "AI PROCESS R&D · CLOSED-LOOP OPTIMIZATION",
    titleA: "Make every experiment ",
    titleB: "converge on a better process.",
    lead: "Ingot turns equipment trajectories, actual recipes, and quality outcomes into learnable experiments, combining physical priors with Bayesian optimization to choose the next run within safe process boundaries.",
    primary: "Explore the product",
    secondary: "View source",
    truth: ["Multi-objective", "Small-data learning", "Safety constraints", "Cross-product transfer"],
    panelKicker: "NEXT RUN · RECOMMENDATION",
    ...
    productText: "This is not an algorithm tab attached to data collection. Data, models, decisions, and knowledge are organized around one question: what experiment should run next?",
    productCards: [
      ["01", "R&D Campaign", "Define controls, objectives, hard bounds, quality constraints, experiment cost, and stopping rules."],
      ["02", "Automatic observations", "RunKey joins setpoints, realized trajectories, process features, inspections, and validity."],
    ...
    visionKicker: "FROM ONE PROCESS TO THE NEXT",
    visionTitle: "Change the scenario, not the optimization system.",
    visionText: "The reusable asset is not an address map for any device. It is the complete capability for sequential experiment optimization.",
    reusable: [
