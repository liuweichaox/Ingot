...
const copy = {
  zh: {
    ...
    titleA: "看清这一炉，",
    titleB: "算准下一炉。",
    lead: "Ingot 把设备轨迹、实际配方和质量结果连成可追溯证据：先定位这一炉的偏差来自哪个变量、哪段轨迹，再让物理先验与贝叶斯优化决定下一炉——更少试验，更快收敛，并始终尊重工艺安全边界。",
    primary: "探索产品能力",
    secondary: "查看源代码",
    truth: ["偏差归因", "多目标优化", "小样本学习", "安全约束"],
    ...
    productText: "不是在采集系统上附加一个算法页面，而是围绕“这一炉为什么不行、下一次该做什么实验”这两个问题重新组织数据、模型、决策和知识。",
    productCards: [
      ["01", "研发 Campaign", "定义控制变量、目标、硬边界、质量约束、试验成本和停止条件。"],
      ["02", "证据成组与追因", "用 RunKey 关联设定值、实际轨迹、过程特征和检验结果，比对周期定位偏差来源与候选变量。"],
