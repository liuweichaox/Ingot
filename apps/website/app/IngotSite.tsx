...
const copy = {
  zh: {
    ...
    productText: "从定义工艺语义、连接现场设备开始，把生产周期、过程轨迹和质量结果形成可信证据；先完成工艺追因，再通过受控实验进入工艺优化。",
    productCards: [
      ["01", "工艺定义", "定义设备、产品、工艺变量、标准单位、配方参数和质量指标，先明确平台需要理解什么。"],
      ["02", "设备接入", "选择通信驱动，测试真实连接，把寄存器、节点或字段映射到稳定的工艺变量。"],
      ["03", "生产采集", "依据生产开始和结束形成周期，持续记录阶段号、过程轨迹、实际配方与运行上下文。"],
      ["04", "数据闭环", "检查时间、缺失和异常，将检验结果关联到同一生产周期，形成可分析的可信证据。"],
      ["05", "工艺追因", "对比合格与不合格运行，识别偏差变量、轨迹区段、可控因素与可能混杂。"],
      ["06", "工艺优化", "设计受控实验，验证安全候选，把确认有效的参数固化为配方版本、工艺窗口和知识。"],
    ],
  ...
  en: {
    ...
    productText: "Start by defining process semantics and connecting real equipment. Turn production runs, trajectories, and quality outcomes into trustworthy evidence; diagnose first, then optimize through controlled experiments.",
    productCards: [
      ["01", "Define the process", "Define equipment, products, process variables, standard units, recipe parameters, and quality objectives."],
      ["02", "Connect equipment", "Select a driver, test the live connection, and map registers, nodes, or fields to stable process variables."],
      ["03", "Collect production data", "Form runs from actual start and end signals while recording stages, trajectories, recipes, and context."],
      ["04", "Close the data loop", "Check timestamps, gaps, and anomalies, then link inspections to the same run to create analysis-ready evidence."],
      ["05", "Diagnose the process", "Compare passing and failing runs to identify deviation variables, trajectory segments, controls, and confounders."],
      ["06", "Process optimization", "Run controlled experiments, verify safe candidates, and publish validated recipes, process windows, and knowledge."],
    ],
    loopKicker: "THE SELF-IMPROVING LOOP",
    ...
    loopSteps: [
      ["01", "Define", "variables · recipes · quality"],
      ["02", "Connect", "protocols · points · conversion"],
      ["03", "Collect", "runs · trajectories · context"],
      ["04", "Qualify", "data quality · inspections"],
      ["05", "Diagnose", "comparison · evidence · hypotheses"],
      ["06", "Optimize", "experiments · verification · standards"],
    ],
    optimizerKicker: "THE NUMERICAL CORE",
