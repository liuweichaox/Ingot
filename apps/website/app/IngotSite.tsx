...
const copy = {
  zh: {
    ...
    titleA: "看清这次运行，",
    titleB: "做对下一项实验。",
    lead: "面向工艺工程师的开源工艺追因与优化系统。统一关联设备、生产和检验数据，支持运行还原、原因验证和安全边界内的下一步实验决策。",
    primary: "五分钟体验",
    secondary: "了解工作方式",
  ...
  en: {
    ...
    lead: "An open-source process diagnosis and optimization system for process engineers. Ingot links equipment, production, and inspection data to support run reconstruction, cause validation, and next-experiment decisions within safety boundaries.",
