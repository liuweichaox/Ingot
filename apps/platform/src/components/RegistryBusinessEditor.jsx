    ...
    <div className="grid gap-5">
      ...
      <Card title="分析方式">
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Field label="同类比较字段" hintVisible hint="多个字段用逗号分隔。" className="md:col-span-2"><Input value={form.comparisonKeys} disabled={readOnly} onChange={event => updateAt(form, onChange, "comparisonKeys", event.target.value)} placeholder="product_family_code, process_specification_id" /></Field>
        </div>
      </Card>
