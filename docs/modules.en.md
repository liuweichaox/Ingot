...
| `Ingot.Platform.Infrastructure` | platform production facts, inspections, webhooks, and Chat fact tools |
...
| `Ingot.Platform.Web` | fact views, inspections, logs, metrics, and the Ingot Chat interface |
