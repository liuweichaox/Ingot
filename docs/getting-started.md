...
> 文档状态：**当前操作指南**。本页提供合成数据流程体验和本地完整栈启动说明。真实试点要求见[受控试点指南](pilot.md)。

## 选择路径

| 目标 | 使用路径 | 完成标志 |
|---|---|---|
| 评估产品流程 | [五分钟合成演示](#五分钟合成演示) | 完成超差运行的比较与实验决策流程 |
...
工作台会引导用户打开一条超差运行、核对已复核检验、选择合格基线、比较实际条件与轨迹，并查看候选原因、混杂因素和下一项验证实验。所有数据均为合成数据；该演示验证页面和流程，不证明真实工艺收益。
...
- 要接入一条真实或代表性运行：继续[受控试点指南](pilot.md)；
