...
真实生产数据、项目与设备标识、工艺参数、质量分布、逐次轨迹和派生结果不进入公开仓库或公开报告。公开材料只发布通用协议、Schema、合成样例、验收方法和不泄露项目事实的结论边界；合成数据只能验证契约和软件行为，不能冒充真实项目证据。

对外可以说明已完成哪个内部验证阶段，但必须同时说明其非公开、不能被公众独立复现，并且不声称未经前瞻受控验证的量化收益。
