...
const ingestionTasks = [
  { taskId: "INGEST-PRESS-01", version: 4, name: "压机 01 实时采集", edgeId: "edge-shanghai-01", protocol: "opc-ua", status: "published", configurationHash: "sha256:demo-published", source: { endpoint: "opc.tcp://press-01:4840" }, valueMappings: [{ source: "ns=2;s=Temp", target: "mold.temperature" }, { source: "ns=2;s=Force", target: "press.force" }], processSpecification: { parameterMappings: [{ source: "ns=2;s=SetTemp", target: "holding.temperature" }, { source: "ns=2;s=SetForce", target: "holding.pressure" }] }, lifecycle: { startEvent: "CycleStarted", completeEvent: "CycleCompleted" }, updatedAt: minutesAgo(30) },
  { taskId: "INGEST-VISION-01", version: 2, name: "视觉检测数据", edgeId: "edge-shanghai-02", protocol: "mqtt", status: "published", configurationHash: "sha256:demo-vision", valueMappings: [{ source: "surface_error", target: "surface.error" }], processSpecification: { parameterMappings: [] }, lifecycle: { completeEvent: "InspectionCompleted" }, updatedAt: hoursAgo(2) },
  { taskId: "INGEST-LAB-DRAFT", version: 1, name: "实验室仪器候选接入", edgeId: "edge-lab-01", protocol: "http-polling", status: "draft", valueMappings: [], processSpecification: { parameterMappings: [] }, updatedAt: minutesAgo(15) },
  { taskId: "INGEST-LEGACY", version: 1, name: "停用旧采集", edgeId: "edge-shanghai-01", protocol: "modbus-tcp", status: "retired", valueMappings: [], processSpecification: { parameterMappings: [] }, updatedAt: daysAgo(30) },
];
...
const toolingComponents = [{ componentId: "INSERT-UPPER-001", componentTypeCode: "MOLD-INSERT", assetCode: "MC-UP-001", serialNumber: "SN-1001", name: "上模芯 001", status: "active" }, { componentId: "INSERT-LOWER-001", componentTypeCode: "MOLD-INSERT", assetCode: "MC-LOW-001", serialNumber: "SN-1002", name: "下模芯 001", status: "active" }, { componentId: "INSERT-RETIRED", componentTypeCode: "MOLD-INSERT", assetCode: "MC-OLD-009", serialNumber: "SN-0009", name: "旧模芯", status: "retired" }];
const toolingTypes = [{ toolingTypeCode: "OPTICAL-MOLD", version: 2, name: "光学模具装配模板", status: "published", roles: [{ code: "upper", name: "上模", maxCount: 1, required: true, sortOrder: 1, acceptedComponentTypeCodes: ["MOLD-INSERT"] }, { code: "lower", name: "下模", maxCount: 1, required: true, sortOrder: 2, acceptedComponentTypeCodes: ["MOLD-INSERT"] }] }];
...
const toolingRevisions = [{ assemblyRevisionId: "MOLD-A-01-R3", toolingAssemblyId: "MOLD-A-01", revision: 3, toolingTypeCode: "OPTICAL-MOLD", toolingTypeVersion: 2, status: "released", createdAt: daysAgo(5), members: [{ roleCode: "upper", componentId: "INSERT-UPPER-001" }, { roleCode: "lower", componentId: "INSERT-LOWER-001" }] }];
