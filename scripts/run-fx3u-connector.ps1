...
$env:Acquisition__Enabled = "false"
$env:Acquisition__AllowLocalFallbackWhenPlatformAvailable = "false"
$env:Acquisition__DeploymentCachePath = Join-Path $runtimeRoot "acquisition-deployments.json"
