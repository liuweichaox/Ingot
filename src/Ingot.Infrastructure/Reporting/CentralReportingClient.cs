...
namespace Ingot.Infrastructure.Reporting;

/// <summary>
///     Connector Host 向 Central 注册并发送心跳；注册使用 1 到 30 秒指数退避。
/// </summary>
public sealed class CentralReportingClient : ICentralReportingClient
{
    private static readonly JsonSerializerOptions JsonOptions = new(JsonSerializerDefaults.Web);

    private readonly IHttpClientFactory _httpClientFactory;
    private readonly IEdgeIdentityProvider _identity;
    private readonly ILogger<CentralReportingClient> _logger;
    ...
    public bool TryInitialize(string? listenUrls)
    {
        ...
        _http = _httpClientFactory.CreateClient(nameof(CentralReportingClient));
        _http.BaseAddress = baseUri;

        _logger.LogInformation("中心上报启用：EdgeId={EdgeId}, Central={Central}, HostBaseUrl={HostBaseUrl}",
