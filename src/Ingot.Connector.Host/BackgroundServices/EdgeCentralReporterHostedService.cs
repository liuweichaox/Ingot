...
/// 宿主只保留节拍循环，HTTP 客户端与重试逻辑见 ICentralReportingClient 实现。
/// </summary>
public sealed class EdgeCentralReporterHostedService(
    ICentralReportingClient client,
    IConfiguration configuration,
    ILogger<EdgeCentralReporterHostedService> logger) : BackgroundService
{
