...
public sealed class CompareTimeWindowsTool(ITimeWindowComparisonService comparisons) : IAnalysisTool
{
        ...
        CancellationToken ct = default)
    {
        ...
        var windows = JsonSerializer.Deserialize<TimeWindowSelection[]>(
            ...
            JsonOptions) ?? [];
        var result = await comparisons.CompareAsync(new TimeWindowComparisonRequest
        {
