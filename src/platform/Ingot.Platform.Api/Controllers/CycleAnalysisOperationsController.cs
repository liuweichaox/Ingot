...
[ApiController]
[Route("api/v1/cycle-analysis-backfills")]
public sealed class CycleAnalysisBackfillsController(
    ICycleAnalysisMaterializationStore store,
    CycleAnalysisBackfillService backfill,
    PlatformUserResolver userResolver) : PlatformConfigurationControllerBase(userResolver)
{
    ...
    public async Task<IActionResult> Enqueue(
        [FromBody] CycleAnalysisBackfillRequest request,
...
[ApiController]
[Route("api/v1/cycle-feature-aggregates")]
public sealed class CycleFeatureAggregatesController(
    ICycleAnalysisMaterializationStore store,
    PlatformUserResolver userResolver) : PlatformConfigurationControllerBase(userResolver)
{
    [HttpGet]
